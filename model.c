...
void setQ(double **Qmatrix, double s, double d, double w1, double w2,
	  int *VectCoevComb){
...
void setQSimulator(double **Qmatrix, double s, double d, double r1, double r2,int *VectCoevComb,double *freqVector)
{
  ...
  else
  {
    ...
    //Multiply by frequency vector: freqVector
    for (loop_i=0;loop_i<nrComb;loop_i++){ 
        for (loop_j=0;loop_j<nrComb;loop_j++){ 
            Qmatrix[loop_i][loop_j]=Qmatrix[loop_i][loop_j] * freqVector[loop_j];
        } 
    }
    /*for (loop_i=0;loop_i<nrComb;loop_i++){ 
     for (loop_j=0;loop_j<nrComb;loop_j++){ 
    ...
    for (loop_i=0;loop_i<nrComb;loop_i++){ 
        for (loop_j=0;loop_j<nrComb;loop_j++){ 
            QmatrixTemp[loop_i][loop_j]= freqVector[loop_i]*Qmatrix[loop_i][loop_j] ;
        } 
    }
    ...
    for (loop_i=0;loop_i<nrComb;loop_i++){ 
        for (loop_j=0;loop_j<nrComb;loop_j++){ 
            //printf("Scale %g into ",Qmatrix[loop_i][loop_j]);
            Qmatrix[loop_i][loop_j]=Qmatrix[loop_i][loop_j] /scale;
            //printf("%g using %f\n",Qmatrix[loop_i][loop_j],scale);
        } 
    }
